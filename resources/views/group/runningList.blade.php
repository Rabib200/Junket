...
<body>
    ...
    margin-top: -2rem;
            ">
                <form action="{{ url("group/runningPlan/search") }}" method="GET" role="search">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-primary" onclick="window.location.href='{{ url("group/runningPlanEdit/$runningPlan->id") }}'">Edit</button>
