    ...
    <div class="limiter">
      ...
      >
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
          <form class="login100-form validate-form" action="{{ url('group/register/create') }}" method="post" enctype="multipart/form-data">
            @csrf
            <span class="login100-form-title p-b-49"> Register as a Group </span>
            ...
            <div class="wrap-input100 m-t-5">
              <textarea class="input100" name="location"  cols="30" rows="10" placeholder="Location"></textarea>
            </div>
            <div class="wrap-input100 m-t-5">
              <textarea class="input100" name="about_us"  cols="30" rows="10" placeholder="About Us"></textarea>
            </div>
